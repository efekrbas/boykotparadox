...
export function Ataturk3DScene() {
  return (
    <section
      id="anit"
      className="relative overflow-hidden border-y-2 border-ink bg-ink text-paper min-h-[calc(100vh-60px)] flex flex-col justify-center py-10 sm:py-16 scroll-mt-14 sm:scroll-mt-16"
    >
